            ...
            for add_2 in address_2:
                ...
                if ( addr_less in add_2[1]):
                    ...
                    if(append_pair in true_addrs):
                        ...
                        temp_pair.append("NOT SURE")
                    else:
                        temp_pair.append("")

                    mapping_result.append(temp_pair)
                    print("new pair:", temp_pair)
                    num_continue = 0
